...
public class CancelFocusServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("[Begin]CancelFocusServlet");
		...
		System.out.println("[Tip]动作：取消关注");
		boolean flag = RelationBiz.getInstance().relation_delete(from_id, to_id);
		if(flag == false){
			System.out.println("[Error]取消关注失败");
		...
		System.out.println("[End]CancelFocusServlet");
	}
